...
Comunicación RF experimental en bandas de 2.4 GHz para:
pruebas de laboratorio,
análisis de paquetes,
detección de actividad RF,
mediciones comparativas.
🔋 Portabilidad total
Batería interna, tamaño compacto, ideal para pruebas de campo controladas.
🧩 Firmware ligero y rápido
Interacción inmediata y menús optimizados.
🔐 Enfoque ético de investigación
No se incentiva ni documenta el uso ilegal de RF ni interferencias activas.
